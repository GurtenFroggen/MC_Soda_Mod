...
@Mod("soda")
public class SodaMod {
	public static final Logger LOGGER = LogManager.getLogger(SodaMod.class);
	public static final String MODID = "soda";
